...
export default function listpribadi({ auth }) {
    ...
    async function deletePengabdian(e, id) {
        ...
        if (confirm("Hapus Pengabdian?")) {
            ...
            try {
                const response = await axios.post("/delete-pribadi", data);
    ...
    async function updatePengabdian(e, id) {
        ...
        if (confirm("update permission Pengabdian?")) {
            ...
            try {
                const response = await axios.post("/update-pribadi", data);
                if (response.data.code !== 0) {
                    toast.error(response.data.msg, {
                        position: "top-right",
                        autoClose: 3000,
    ...
    async function getListUser(page = 1, length = 10, username, role, tahun) {
        ...
        try {
            const response = await axios.get("/list-pribadi-request", {
                params: parameter,
            });
            if (response.data.code !== 0) {
                toast.error(response.data.msg, {
